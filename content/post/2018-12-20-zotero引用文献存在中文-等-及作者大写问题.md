---
title: Zotero引用文献存在中文“等”及作者大写问题
author: 波比
date: '2018-12-20'
slug: zotero引用文献存在中文-等-及作者大写问题
categories:
  - 科研
tags:
  - zotero
...
Zotero是科研工作者的一款神器。但是对于中文环境的工作者几乎就是噩梦参考文献英文作者名字全是大写，et al 会自动写成“等”。现在将CSL的代码贴出来，自己改就好了。

适用Chinese Std GB/T 7714-1987 (numeric, Chinese) 
...
<style class="in-text" version="1.0" demote-non-dropping-particle="sort-only" default-locale="en-US" xmlns="http://purl.org/net/xbiblio/csl">
  ...
  <info>
    ...
    <id>http://www.zotero.org/styles/chinese-std-gb-t-7714-1987</id>
    <link href="http://www.zotero.org/styles/chinese-std-gb-t-7714-1987" rel="self"/>
    ...
    <updated>2018-10-14T08:44:18+00:00</updated>
...
将代码中的内容复制到txt文本文件中，另存为chinese-gb7714-numeric.csl。然后在zotero软件中将本地的csl文件导入即可。
